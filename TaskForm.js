    ...
    useEffect(() => {
        ...
        if (taskId && token) {
            axios.get(`http://localhost:5000/tasks/${taskId}`, {
                headers: {
                    Authorization: `Bearer ${'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyIjp7ImlkIjoiNjZjNTZlNmFhNDNjNWY4ZDk1ODQxYjhkIn0sImlhdCI6MTcyNDI3Nzg1MywiZXhwIjoxNzI0MjgxNDUzfQ.tvbL5WG-qNlRvxKZ8xtuq03BjxeGCXT0injDClo310U'}`, // Include the token in the request headers
                },
            })
